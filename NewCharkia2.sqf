	...
	[
		...
		"heli_troopers",
            [
                ...
                2,              						// SCALAR: Maximum number of AI to eject from the aircraft. Set to a really high # to ignore (like 999).
                true,              						// BOOLEAN: Whether or not to keep the heli flying around as a gunship.
		        [20463.2,11747.1,0],      				// OBJECT or ARRAY (OPTIONAL - Position2D or 3D): The location to drop the reinforcements at. The drop point will default to the group leader.
		        "I_Heli_light_03_dynamicLoadout_F"		// CLASS of heli to spawn 
				]
		],
	[
		_group,			// pass the group
